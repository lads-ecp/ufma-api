...
class MonografiaCollection (Resource):
    ...
    def get(self):
        ...
        if request.headers['accept'] == 'application/xml':
            dados_rdf = list(map(lambda mono: MonografiaRDF(mono.codigo, mono.titulo, mono.codigo_curso,
                                                            mono.discente, mono.siape_orientador), query.order_by(Monografia.titulo).all()))
